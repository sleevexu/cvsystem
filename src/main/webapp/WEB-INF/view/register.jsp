        ...
        <div class="col-md-8 col-md-offset-2">
            <div class="login-panel panel panel-default">
                ...
                <div class="panel-body">
                    <form  class="form-horizontal" role="form" action="/cvsystem/registerUser" method="post">
                        <fieldset>
                            <div class="row">
                                <div class="col-sm-8 col-sm-offset-2">
                                    <div class="form-group">
                                        <div class="input-group">
                                            ...
                                            <input class="form-control" placeholder="用户名" id="userName" name="userName" aria-describedby="user-addon"/>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <div class="input-group">
